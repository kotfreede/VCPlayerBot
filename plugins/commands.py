...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('☸Repository☸', url='https://github.com/kotfreede/VCPlayerBot'),
            InlineKeyboardButton('🔱BOTS Channel🔱', url='https://t.me/KOT_BOTS'),
            
        ],
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://github.com/Thor-Ragnarokk/VCPlayerBot>VCPlayerBot.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons))
