...
async def not_chat(_, m: Message):
    buttons = [
        [
            InlineKeyboardButton('⚡️Make Own Bot🤩', url='https://github.com/Thor-Ragnarokk/VCPlayerBot'),
            InlineKeyboardButton('Join Here', url='https://t.me/DHM_MoviesStream'),
        ]
        ]
    await m.reply("<b>You can't use this bot in this group, for that you have to make your own bot from the [SOURCE CODE](https://github.com/Thor-Ragnarokk/VCPlayerBot) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
